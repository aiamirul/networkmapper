...
const getDeviceIconSvg = (type: DeviceType): string => {
    ...
    // FIX: Changed camelCase SVG attributes (e.g. strokeWidth) to kebab-case (e.g. stroke-width)
    // for correct parsing when used as an HTML string with d3.
    const paths: Record<DeviceType, string> = {
// FIX: Changed camelCase SVG attributes to kebab-case.
